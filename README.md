...
📊 **186 Repositories** in **7 Kategorien**  
🕐 **Letztes Update:** 2026-05-05 05:48:42  
🤖 **Generiert mit:** Atlassian CLI (ACLI) Rovo Dev

## 📂 Kategorien-Übersicht

- [Web Development](#web-development-65-repositories) (65 Repositories)
...
## Web Development (65 Repositories)

### [openclaw](https://github.com/openclaw/openclaw)
Your own personal AI assistant. Any OS. Any Platform. The lobster way. 🦞 

**Details:** ⭐ 368374 `TypeScript` `ai`, `assistant`, `own-your-data`
...
**Details:** ⭐ 186715 `TypeScript` `automation`, `ipaas`, `n8n`
...
**Details:** ⭐ 45747 `TypeScript` `react`, `video`, `javascript`
...
**Details:** ⭐ 45237 `TypeScript` `spec`, `ai`, `context-engineering`
...
**Details:** ⭐ 26601 `JavaScript` `claude`, `codex`, `marketing`
...
**Details:** ⭐ 24115 `TypeScript` `data-format`, `llm`, `serialization`
...
**Details:** ⭐ 21727 `TypeScript` `anthropic`, `anthropic-claude`, `claude`
...
**Details:** ⭐ 20010 `TypeScript` `claude-code`, `claude-desktop`, `codex`
...
**Details:** ⭐ 18909 `TypeScript` `ai-coding`, `vscode`, `vscode-extension`
...
**Details:** ⭐ 16465 `TypeScript` `reactjs`, `tailwindcss`, `ui-system`
...
**Details:** ⭐ 15416 `TypeScript` `cli`, `command`, `vercel`
...
**Details:** ⭐ 14614 `TypeScript` `ai`, `cursor`, `figma`
...
**Details:** ⭐ 8011 `TypeScript` `authoring`, `documentation`, `markdoc`
...
**Details:** ⭐ 4684 `TypeScript` `ai-design`, `anthropic`, `byok`
...
**Details:** ⭐ 1252 `TypeScript` `drag-and-drop`, `homelab`, `rack`
...
**Details:** ⭐ 540 `TypeScript` `ai`, `artifacts`, `boilerplate`
...
**Details:** ⭐ 539 `TypeScript` `mcp`, `mcp-server`, `mermaid`
...
**Details:** ⭐ 538 `TypeScript` `cli`, `mcp`, `mcp-client`
...
**Details:** ⭐ 45 `TypeScript` `ai-tools`, `claude-code`, `developer-tools`
...
**Details:** ⭐ 38  `automation`, `crypto`, `defi`
...
**Details:** ⭐ 132973 `Python` `ai`, `ai-agent`, `ai-agents`
...
**Details:** ⭐ 128165 `Python` `agent-skills`
...
**Details:** ⭐ 92513 `Python` `ai`, `copilot`, `development`
...
**Details:** ⭐ 68478 `Python` `python`, `ansible`
...
**Details:** ⭐ 57977 `Python` `claude`, `claude-code`, `agent-skills`
...
**Details:** ⭐ 53911 `Python` `ai`, `anthropic`, `caveman`
...
**Details:** ⭐ 51137 `Python` `ai`, `chromadb`, `llm`
...
**Details:** ⭐ 27135 `Jupyter Notebook` `rag`, `tutorials`, `langchain`
...
**Details:** ⭐ 25753 `Rust` `google-workspace`, `agent-skills`, `ai-agent`
...
**Details:** ⭐ 24891 `Python` `agents`, `artificial-intelligence`, `cybersecurity`
...
**Details:** ⭐ 10258 `Python` `honeypot`, `awesome-list`, `awesome`
...
**Details:** ⭐ 5650  `infosec`, `pentest`, `courses`
...
**Details:** ⭐ 4767 `Python` `python`, `ricing`, `status-bar`
...
**Details:** ⭐ 4258 `C#` `defender`, `firewall-configuration`, `harden`
...
**Details:** ⭐ 2599 `Python` `azure-active-directory`, `azuread`, `microsoft-graph`
...
**Details:** ⭐ 2334 `YAML` `apple`, `macos`, `compliance`
...
**Details:** ⭐ 1709 `Python` `agent-skills`, `ai`, `automation`
...
**Details:** ⭐ 837 `Python` `agent-skills`, `opc`, `ai-tools`
...
**Details:** ⭐ 833 `Groovy` `docs-as-code`, `asciidoc`, `asciidoctor`
...
**Details:** ⭐ 78 `Python` `ai`, `fastapi`, `llm`
...
**Details:** ⭐ 53299 `C#` `powershell`, `windows`, `macos`
...
**Details:** ⭐ 20863  `awesome-list`, `awesome`, `list`
...
**Details:** ⭐ 10781 `C#` `mremoteng`, `rdp`, `ssh`
...
**Details:** ⭐ 3923  `awesome-list`, `internet-of-things`, `iot`
...
**Details:** ⭐ 1408 `Svelte` `private-notes`, `privnote`, `secure-notes`
...
**Details:** ⭐ 507 `PowerShell` `winforms`, `powershell`, `gui`
...
**Details:** ⭐ 467 `PowerShell` `crowdstrike`, `falcon`, `oauth2-client`
...
**Details:** ⭐ 27754 `Swift` `macos`, `menubar`, `statusbar`
...
**Details:** ⭐ 20715 `C++` `kodi`, `home-theater`, `media-center`
...
**Details:** ⭐ 17523 `Swift` `openemu`, `objective-c`, `macos`
...
**Details:** ⭐ 2355 `Swift` `claude`, `claude-ai`, `claude-code`
...
**Details:** ⭐ 837 `PowerShell` `agent-skills`
...
**Details:** ⭐ 21119 `Rust` `speech-to-text`, `tauri-v2`, `accessibility`
...
**Details:** ⭐ 14485 `Rust` `tiling-window-manager`, `windows`, `rust`
...
**Details:** ⭐ 7475 `C++` `desktop`, `windows`, `xaml`
...
**Details:** ⭐ 4903 `Rust` `identity`, `identity-management`, `idm`
...
**Details:** ⭐ 3324 `C++` `logs`, `windows`, `linux`
...
**Details:** ⭐ 2007 `C` `openssh`, `openssh-server`, `windows`
...
**Details:** ⭐ 185 `Rust` `cmtrace`, `intune`
...
**Details:** ⭐ 28729  `claude`, `codex`, `obsidian`
...
**Details:** ⭐ 54584 `PHP` `nodejs`, `mysql`, `php`
...
**Details:** ⭐ 6113 `Groovy` `rundeck`, `devops`, `deployment`
...
**Details:** ⭐ 54 `Go` `automation`, `compliance`, `grc`
