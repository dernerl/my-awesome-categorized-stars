...
📊 **196 Repositories** in **7 Kategorien**  
🕐 **Letztes Update:** 2026-06-09 06:54:28  
🤖 **Generiert mit:** Atlassian CLI (ACLI) Rovo Dev

## 📂 Kategorien-Übersicht

- [Web Development](#web-development-70-repositories) (70 Repositories)
- [Data Science & ML](#data-science--ml-50-repositories) (50 Repositories)
- [Other](#other-40-repositories) (40 Repositories)
- [Mobile Development](#mobile-development-13-repositories) (13 Repositories)
- [Programming Languages](#programming-languages-10-repositories) (10 Repositories)
- [Utilities & Tools](#utilities--tools-8-repositories) (8 Repositories)
- [DevOps & Infrastructure](#devops--infrastructure-5-repositories) (5 Repositories)
...
**Details:** ⭐ 377717 `TypeScript` `ai`, `assistant`, `own-your-data`
...
**Details:** ⭐ 191678 `TypeScript` `automation`, `ipaas`, `n8n`
...
**Details:** ⭐ 124928 `TypeScript` `productivity`, `collaboration`, `diagrams`
...
**Details:** ⭐ 70286 `JavaScript` `ai`, `anthropic`, `caveman`
...
**Details:** ⭐ 61917 `TypeScript` `ai-agents`, `ai-design`, `byok`
...
**Details:** ⭐ 53655 `TypeScript` `spec`, `ai`, `context-engineering`
...
**Details:** ⭐ 49467 `TypeScript` `react`, `video`, `javascript`
...
**Details:** ⭐ 32561 `JavaScript` `claude`, `codex`, `marketing`
...
**Details:** ⭐ 24506 `TypeScript` `data-format`, `llm`, `serialization`
...
**Details:** ⭐ 22012 `TypeScript` `anthropic`, `anthropic-claude`, `claude`
...
**Details:** ⭐ 21719 `TypeScript` `claude-code`, `claude-desktop`, `codex`
...
**Details:** ⭐ 19947 `TypeScript` `ai-coding`, `vscode`, `vscode-extension`
...
**Details:** ⭐ 16468 `TypeScript` `reactjs`, `tailwindcss`, `ui-system`
...
**Details:** ⭐ 15629 `TypeScript` `cli`, `command`, `vercel`
...
**Details:** ⭐ 15040 `TypeScript` `ai`, `cursor`, `figma`
...
**Details:** ⭐ 8043 `TypeScript` `authoring`, `documentation`, `markdoc`
...
**Details:** ⭐ 6728 `TypeScript` `ai-design`, `anthropic`, `byok`
...
**Details:** ⭐ 5667 `JavaScript` `django`, `python`, `graphite`
...
**Details:** ⭐ 5229 `TypeScript` `agentic-ai`, `antigravity`, `cerebras`
...
**Details:** ⭐ 2517 `TypeScript` `deutsche-bahn`, `open-source`, `railway`
...
**Details:** ⭐ 2352 `TypeScript` `customer-feedback`, `self-hosted`, `ruby-on-rails`
...
**Details:** ⭐ 1363 `TypeScript` `drag-and-drop`, `homelab`, `rack`
...
**Details:** ⭐ 679 `TypeScript` `cli`, `mcp`, `mcp-client`
...
**Details:** ⭐ 578 `TypeScript` `mcp`, `mcp-server`, `mermaid`
...
**Details:** ⭐ 551 `TypeScript` `ai`, `artifacts`, `boilerplate`
...
**Details:** ⭐ 461 `JavaScript` `claude`, `claudecode`, `databricks`
...
**Details:** ⭐ 409 `TypeScript` `automation`, `build`, `filewatcher`
...
FBPro Audit Test Automation Package allows you to create compliance reports for your systems. The re...

**Details:** ⭐ 168 `PowerShell` `audit`, `compliance`, `cis`
...
**Details:** ⭐ 97 `JavaScript` `shortcuts`, `new`, `create-new-item`
...
**Details:** ⭐ 94 `TypeScript` `deploy`, `deployment`, `docker`
...
**Details:** ⭐ 62 `TypeScript` `ai-tools`, `claude-code`, `developer-tools`

---

### [sketch2prompt](https://github.com/jmassengille/sketch2prompt)
sketch2prompt is meant to promote better system design, security, and code quality in a way that doe...
...
**Details:** ⭐ 39  `automation`, `crypto`, `defi`
...
**Details:** ⭐ 16 `HTML` `github`, `github-pages`, `github-actions`
...
**Details:** ⭐ 5 `TypeScript` `ai`, `architecture-framework`, `enterprise-architecture`
...
MCP server for the ChurchTools API — runs locally via npx (stdio) or as a Streamable HTTP service. F...

**Details:** ⭐ 1 `TypeScript` `church-management`, `churchtools`, `claude`
...
## Data Science & ML (50 Repositories)
...
**Details:** ⭐ 187836 `Python` `ai`, `ai-agent`, `ai-agents`
...
**Details:** ⭐ 148228 `Python` `agent-skills`
...
**Details:** ⭐ 110628 `Python` `ai`, `copilot`, `development`
...
**Details:** ⭐ 68830 `Python` `python`, `ansible`
...
**Details:** ⭐ 63812 `Python` `claude`, `claude-code`, `agent-skills`
...
**Details:** ⭐ 55065 `Python` `ai`, `chromadb`, `llm`
...
**Details:** ⭐ 27785 `Jupyter Notebook` `rag`, `tutorials`, `langchain`
...
**Details:** ⭐ 26956 `Python` `scraping`, `scraping-python`, `llm`
...
**Details:** ⭐ 26932 `Rust` `google-workspace`, `agent-skills`, `ai-agent`
...
**Details:** ⭐ 25904 `Python` `agents`, `artificial-intelligence`, `cybersecurity`
...
**Details:** ⭐ 10340 `Python` `honeypot`, `awesome-list`, `awesome`
...
**Details:** ⭐ 5681  `infosec`, `pentest`, `courses`
...
**Details:** ⭐ 5027 `Python` `python`, `ricing`, `status-bar`
...
**Details:** ⭐ 4308 `C#` `defender`, `firewall-configuration`, `harden`
...
**Details:** ⭐ 2635 `Python` `azure-active-directory`, `azuread`, `microsoft-graph`
...
**Details:** ⭐ 2370 `YAML` `apple`, `macos`, `compliance`
...
**Details:** ⭐ 2107  `ai`, `awesome`, `awesome-list`
...
**Details:** ⭐ 1980 `Python` `agent-skills`, `ai`, `automation`
...
**Details:** ⭐ 920 `Python` `agent-skills`, `opc`, `ai-tools`

---

### [docToolchain](https://github.com/docToolchain/docToolchain)
a AsciiDoc Toolchain for technical Software Documentation, focused on Software Architecture Document...

**Details:** ⭐ 839 `Groovy` `docs-as-code`, `asciidoc`, `asciidoctor`
...
**Details:** ⭐ 497 `Python` `crowdstrike`, `oauth2`, `falconpy`
...
German-OCR is specifically trained to extract text from German documents including invoices, receipt...

**Details:** ⭐ 109 `Python` `fine-tuning`, `llm`, `lora`
...
**Details:** ⭐ 106 `Python` `agent`, `agents`, `ai`

---

### [azure-diagrams-skill](https://github.com/cmb211087/azure-diagrams-skill)
Generate professional technical diagrams with AI - Azure architecture (700+ icons), ERDs, business f...

**Details:** ⭐ 84 `Python` `ai`, `architecture`, `azure`

---

### [rag-template](https://github.com/stackitcloud/rag-template)
Template for AI chatbots & document management using Retrieval-Augmented Generation with vector sear...

**Details:** ⭐ 82 `Python` `ai`, `fastapi`, `llm`
...
**Details:** ⭐ 70 `Python` `active-directory`, `authorized-testing`, `blue-team`

---

### [wardley-maps-mermaid](https://github.com/tractorjuice/wardley-maps-mermaid)
Mirror of swardley/WARDLEY-MAP-REPOSITORY with each map rendered as Mermaid wardley-beta alongside t...
...
**Details:** ⭐ 56 `Python` `architecture`, `code`, `diagrams`

---

### [toktoken](https://github.com/mauriziofonte/toktoken)
TokToken is a fast, single-binary C codebase indexer for AI coding agents. Powered by universal-ctag...
...
This repository contains a collection of PowerShell tools that can be utilized to protect and defend...

**Details:** ⭐ 52 `PowerShell` `wef`, `powershell`, `protections`
...
Claude Certified Architect: Exam Prep & Practice Questions A comprehensive collection of practice qu...
...
Generate Apple Shortcuts from natural language using Claude Code. Describe any automation and get a ...

**Details:** ⭐ 10 `Python` `ai-automation`, `apple-shortcuts`, `claude-code`

---

### [Citrix](https://github.com/Deyda/Citrix)
Focused on automation, optimization, and troubleshooting for Citrix environments — including Virtual...

**Details:** ⭐ 9 `PowerShell` 

---

### [skills](https://github.com/eyesecurity/skills)
EU compliance enforcement for AI agents. Org-profile-driven guardrails for NIS2, GDPR & ISO 27001 — ...

**Details:** ⭐ 6 `Python` `ai-skills`, `claude-code-skill`, `claude-skills`
...
**Details:** ⭐ 4 `Python` `ai-image-generation`, `cli`, `cuda`
...
**Details:** ⭐ 3  `colors`, `neofusion`, `opencode`
...
**Details:** ⭐ 53837 `C#` `powershell`, `windows`, `macos`
...
**Details:** ⭐ 21012  `awesome-list`, `awesome`, `list`
...
**Details:** ⭐ 10864 `C#` `mremoteng`, `rdp`, `ssh`
...
**Details:** ⭐ 5394 `PowerShell` `powershell`, `windows-powershell`, `powershell-ise`
...
🕊️ A crowd-sourced guide to help techs help their non-tech spouses / partners / parents / kids when ...

**Details:** ⭐ 3979  `disaster-response`, `disaster-management`
...
**Details:** ⭐ 3949  `awesome-list`, `internet-of-things`, `iot`
...
**Details:** ⭐ 2859 `PowerShell` `powershell`, `scripting`, `sccm`
...
**Details:** ⭐ 1555 `PowerShell` `devxsample`
...
**Details:** ⭐ 1432 `Svelte` `private-notes`, `privnote`, `secure-notes`
...
**Details:** ⭐ 508 `PowerShell` `winforms`, `powershell`, `gui`
...
**Details:** ⭐ 471 `PowerShell` `crowdstrike`, `falcon`, `oauth2-client`
...
**Details:** ⭐ 257 `PowerShell` `keepass`, `powershell`, `changelog-poshkeepass`
...
Step by step guidance to deploy Azure Active Directory capabilities such as Conditional Access, Mult...
...
### [mcp-server-solidworks](https://github.com/eyfel/mcp-server-solidworks)
 This MCP server integrates with SolidWorks API and structuring it into Claude-compatible context st...
...
**Details:** ⭐ 57 `PowerShell` `cloud-administration`, `cybersecurity`, `enterprise-architecture`
...
**Details:** ⭐ 28  `agent-orchestration`, `agents`, `arc42`

---

### [WHfBChecks](https://github.com/onpremcloudguy/WHfBChecks)
A group of PowerShell scripts to check that your environment is ready for Windows Hello for Business...
...
Native rules, hooks, and guards that prevent Claude Code and Codex from hallucinating code, duplicat...

**Details:** ⭐ 24 `Shell` `claude-code`, `code-quality`, `codex`
...
CoinMarketCap is an MIT licensed PowerShell module providing an easy to use wrapper around the coinm...

**Details:** ⭐ 14 `PowerShell` `coinmarketcap`, `bitcoin`, `cryptocurrencies`
...
## Mobile Development (13 Repositories)

### [Ice](https://github.com/jordanbaird/Ice)
Powerful menu bar manager for macOS

**Details:** ⭐ 28349 `Swift` `macos`, `menubar`, `statusbar`
...
**Details:** ⭐ 20828 `C++` `kodi`, `home-theater`, `media-center`
...
**Details:** ⭐ 17595 `Swift` `openemu`, `objective-c`, `macos`
...
**Details:** ⭐ 2649 `Swift` `claude`, `claude-ai`, `claude-code`
...
**Details:** ⭐ 1522 `PowerShell` `stencils`, `stencils-pack`, `mis-azure`
...
**Details:** ⭐ 1177 `Python` `agent-skills`

---

### [SupportApp](https://github.com/root3nl/SupportApp)
The Support App is developed by Root3, specialized in managing Apple devices. Root3 offers consultan...
...
Mergen is an open-source, native macOS application for auditing and checking the security of your Ma...

**Details:** ⭐ 232 `Swift` `audit`, `macos`, `macos-security`
...
**Details:** ⭐ 54 `Swift` `icns`, `icon`, `command-line`

---

## Programming Languages (10 Repositories)

### [Handy](https://github.com/cjpais/Handy)
A free, open source, and extensible speech-to-text application that works completely offline.

**Details:** ⭐ 23392 `Rust` `speech-to-text`, `tauri-v2`, `accessibility`
...
**Details:** ⭐ 14711 `Rust` `tiling-window-manager`, `windows`, `rust`
...
**Details:** ⭐ 7663 `C++` `desktop`, `windows`, `xaml`
...
**Details:** ⭐ 5032 `Rust` `identity`, `identity-management`, `idm`
...
**Details:** ⭐ 3380 `C++` `logs`, `windows`, `linux`
...
**Details:** ⭐ 2020 `C` `openssh`, `openssh-server`, `windows`
...
**Details:** ⭐ 203 `Rust` `cmtrace`, `intune`
...
**Details:** ⭐ 541 `PowerShell` 

---

### [Powershell_CICD_repository](https://github.com/ztrhgf/Powershell_CICD_repository)
This tool greatly simplifies Windows administrator life by automating the whole scripting content li...

**Details:** ⭐ 173 `PowerShell` `powershell`, `git-hooks`, `cicd`
...
A simple and fast GUI for Microsoft LAPS (legacy) and Windows LAPS. With this tool you can query pas...

**Details:** ⭐ 77 `PowerShell` `laps`, `microsoft`, `windows`
...
A collection of PowerShell-based documentation tools and templates for IT environments. Includes scr...

**Details:** ⭐ 8 `PowerShell` 

---

## DevOps & Infrastructure (5 Repositories)

### [coolify](https://github.com/coollabsio/coolify)
An open-source, self-hostable PaaS alternative to Vercel, Heroku & Netlify that lets you easily depl...

**Details:** ⭐ 56678 `PHP` `nodejs`, `mysql`, `php`
...
**Details:** ⭐ 6136 `Groovy` `rundeck`, `devops`, `deployment`
...
**Details:** ⭐ 52 `Go` `automation`, `compliance`, `grc`
