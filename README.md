...
📊 **103 Repositories** in **30 Kategorien**  
🕐 **Letztes Update:** 2026-01-30 04:45:05  
🤖 **Generiert mit:** Atlassian CLI (ACLI) Rovo Dev

## 📂 Kategorien-Übersicht

- [AI Development Tools](#ai-development-tools-16-repositories) (16 Repositories)
- [Security & Compliance](#security--compliance-16-repositories) (16 Repositories)
- [PowerShell Modules & Tools](#powershell-modules--tools-11-repositories) (11 Repositories)
- [Windows Administration](#windows-administration-9-repositories) (9 Repositories)
- [DevOps & CI/CD](#devops--cicd-6-repositories) (6 Repositories)
- [AI & Machine Learning](#ai--machine-learning-5-repositories) (5 Repositories)
- [Windows UI & Desktop](#windows-ui--desktop-3-repositories) (3 Repositories)
- [macOS Tools](#macos-tools-3-repositories) (3 Repositories)
- [Azure & Cloud](#azure--cloud-3-repositories) (3 Repositories)
- [Documentation Tools](#documentation-tools-3-repositories) (3 Repositories)
- [Workflow Automation](#workflow-automation-2-repositories) (2 Repositories)
- [Visualization & Design](#visualization--design-2-repositories) (2 Repositories)
- [MCP Servers](#mcp-servers-2-repositories) (2 Repositories)
- [Authentication & Identity](#authentication--identity-2-repositories) (2 Repositories)
- [IoT](#iot-2-repositories) (2 Repositories)
- [Microsoft 365 & Teams](#microsoft-365--teams-2-repositories) (2 Repositories)
- [Web Development](#web-development-2-repositories) (2 Repositories)
- [Self-Hosted Services](#self-hosted-services-2-repositories) (2 Repositories)
- [Customer Feedback & Project Management](#customer-feedback--project-management-1-repositories) (1 Repositories)
- [ChurchTools](#churchtools-1-repositories) (1 Repositories)
- [Travel & Transportation](#travel--transportation-1-repositories) (1 Repositories)
- [Citrix Management](#citrix-management-1-repositories) (1 Repositories)
- [System Monitoring & Logging](#system-monitoring--logging-1-repositories) (1 Repositories)
- [Remote Access](#remote-access-1-repositories) (1 Repositories)
- [File Sharing & Security](#file-sharing--security-1-repositories) (1 Repositories)
- [Browser Extensions](#browser-extensions-1-repositories) (1 Repositories)
- [Privacy & Legal](#privacy--legal-1-repositories) (1 Repositories)
- [Chatbots](#chatbots-1-repositories) (1 Repositories)
- [Virtual Desktop Infrastructure](#virtual-desktop-infrastructure-1-repositories) (1 Repositories)
- [Awesome Lists](#awesome-lists-1-repositories) (1 Repositories)


---

## AI Development Tools (16 Repositories)

### [n8n](https://github.com/n8n-io/n8n)
Fair-code workflow automation platform with native AI capabilities. Combine visual building with cus...

**Details:** ⭐ 172067 `TypeScript` `automation`, `ipaas`, `n8n`
...
**Details:** ⭐ 66253 `Python` `ai`, `copilot`, `development`
...
**Details:** ⭐ 22332 `TypeScript` `data-format`, `llm`, `serialization`
...
**Details:** ⭐ 20861 `TypeScript` `spec`, `ai`, `context-engineering`
...
**Details:** ⭐ 20274 `TypeScript` `anthropic`, `anthropic-claude`, `claude`
...
**Details:** ⭐ 12894 `TypeScript` `ai`, `cursor`, `figma`
...
**Details:** ⭐ 391 `TypeScript` `mcp`, `mcp-server`, `mermaid`

---

### [mcp-cli](https://github.com/apify/mcp-cli)
Universal CLI client for MCP. Supports persistent sessions, stdio/HTTP, OAuth 2.1, JSON output for s...

**Details:** ⭐ 244 `TypeScript` `cli`, `mcp`, `mcp-client`
...
## Security & Compliance (16 Repositories)

### [awesome-honeypots](https://github.com/paralax/awesome-honeypots)
an awesome list of honeypot resources

**Details:** ⭐ 10105 `Python` `honeypot`, `awesome-list`, `awesome`
...
**Details:** ⭐ 5576  `infosec`, `pentest`, `courses`
...
**Details:** ⭐ 4023 `C#` `defender`, `firewall-configuration`, `harden`
...
**Details:** ⭐ 2505 `Python` `azure-active-directory`, `azuread`, `microsoft-graph`
...
**Details:** ⭐ 2229 `YAML` `apple`, `macos`, `compliance`
...
**Details:** ⭐ 449 `PowerShell` `crowdstrike`, `falcon`, `oauth2-client`
...
**Details:** ⭐ 14 `TypeScript` `falcon-foundry`
...
**Details:** ⭐ 51303 `C#` `powershell`, `windows`, `macos`
...
**Details:** ⭐ 5333 `PowerShell` `powershell`, `windows-powershell`, `powershell-ise`
...
**Details:** ⭐ 1962 `C` `openssh`, `openssh-server`, `windows`
...
## Windows Administration (9 Repositories)
...
**Details:** ⭐ 1519 `PowerShell` `devxsample`
...
**Details:** ⭐ 62 `PowerShell` `laps`, `microsoft`, `windows`
...
**Details:** ⭐ 2093  `ai`, `awesome`, `awesome-list`
...
## Windows UI & Desktop (3 Repositories)

### [Ice](https://github.com/jordanbaird/Ice)
Powerful menu bar manager for macOS

**Details:** ⭐ 25695 `Swift` `macos`, `menubar`, `statusbar`
...
**Details:** ⭐ 13930 `Rust` `tiling-window-manager`, `windows`, `rust`
...
**Details:** ⭐ 7257 `C++` `desktop`, `windows`, `xaml`

---

## macOS Tools (3 Repositories)
...
## Workflow Automation (2 Repositories)

### [BMAD-METHOD](https://github.com/bmad-code-org/BMAD-METHOD)
Breakthrough Method for Agile Ai Driven Development

**Details:** ⭐ 32916 `JavaScript` 
...
## Visualization & Design (2 Repositories)
...
## MCP Servers (2 Repositories)

### [servers](https://github.com/modelcontextprotocol/servers)
Model Context Protocol Servers

**Details:** ⭐ 77538 `TypeScript` 
...
## Authentication & Identity (2 Repositories)
...
**Details:** ⭐ 3827  `awesome-list`, `internet-of-things`, `iot`
...
## Microsoft 365 & Teams (2 Repositories)
...
## Web Development (2 Repositories)
...
## Self-Hosted Services (2 Repositories)
...
**Details:** ⭐ 2346 `TypeScript` `customer-feedback`, `self-hosted`, `ruby-on-rails`

---

## ChurchTools (1 Repositories)
...
## Travel & Transportation (1 Repositories)
...
**Details:** ⭐ 2458 `TypeScript` `deutsche-bahn`, `open-source`, `railway`

---

## Citrix Management (1 Repositories)
...
## System Monitoring & Logging (1 Repositories)
...
**Details:** ⭐ 10525 `C#` `mremoteng`, `rdp`, `ssh`

---

## File Sharing & Security (1 Repositories)
...
**Details:** ⭐ 1326 `Svelte` `private-notes`, `privnote`, `secure-notes`
...
## Virtual Desktop Infrastructure (1 Repositories)
...
## Awesome Lists (1 Repositories)

### [awesome-readme](https://github.com/matiassingers/awesome-readme)
A curated list of awesome READMEs

**Details:** ⭐ 20348  `awesome-list`, `awesome`, `list`
...
| Kategorie | Anzahl |
|-----------|--------|
| AI Development Tools | 16 |
| Security & Compliance | 16 |
| PowerShell Modules & Tools | 11 |
| Windows Administration | 9 |
| DevOps & CI/CD | 6 |
| AI & Machine Learning | 5 |
| Windows UI & Desktop | 3 |
| macOS Tools | 3 |
| Azure & Cloud | 3 |
