...
📊 **70 Repositories** in **18 Kategorien**  
🕐 **Letztes Update:** 2025-10-24 14:42:43  
...
**Details:** ⭐ 9765 `Python` `honeypot`, `awesome-list`, `awesome`
...
**Details:** ⭐ 2426 `Python` `azure-active-directory`, `azuread`, `microsoft-graph`
...
**Details:** ⭐ 151413 `TypeScript` `automation`, `ipaas`, `n8n`
...
**Details:** ⭐ 11376 `TypeScript` `ai`, `cursor`, `figma`
...
## System Administration & IT Management (11 Repositories)
...
**Details:** ⭐ 1486 `PowerShell` `devxsample`
...
## PowerShell Tools & Scripts (10 Repositories)

### [PowerShell](https://github.com/PowerShell/PowerShell)
PowerShell for every system!

**Details:** ⭐ 50445 `C#` `powershell`, `windows`, `macos`
...
**Details:** ⭐ 5252 `PowerShell` `powershell`, `windows-powershell`, `powershell-ise`
...
## Development Tools & IDE (4 Repositories)
...
**Details:** ⭐ 2332 `TypeScript` `deutsche-bahn`, `open-source`, `railway`

---

## Remote Access & Connectivity (2 Repositories)
...
**Details:** ⭐ 1924 `C` `openssh`, `openssh-server`, `windows`
...
**Details:** ⭐ 3048 `C++` `logs`, `windows`, `linux`
...
**Details:** ⭐ 13069 `Rust` `tiling-window-manager`, `windows`, `rust`

---

## Documentation & Resources (6 Repositories)
...
**Details:** ⭐ 19905  `awesome-list`, `awesome`, `list`
...
## Cross-Platform Tools (1 Repositories)
...
## Certificate & Evaluation Tools (1 Repositories)
...
## Password & Credential Management (1 Repositories)
...
| System Administration & IT Management | 11 |
| PowerShell Tools & Scripts | 10 |
| AI & Machine Learning | 6 |
| DevOps & Automation | 6 |
| Documentation & Resources | 6 |
| Development Tools & IDE | 4 |
| Remote Access & Connectivity | 2 |
| Logging & Monitoring | 2 |
| Browser Extensions & Web Tools | 2 |
| Web3 & Blockchain | 1 |
| Transportation & Travel | 1 |
| Window Management | 1 |
| Cross-Platform Tools | 1 |
| Certificate & Evaluation Tools | 1 |
| Password & Credential Management | 1 |
| Church Management | 1 |
| Azure & Cloud Services | 1 |

**Gesamt:** 70 Repositories
