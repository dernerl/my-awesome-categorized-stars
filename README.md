...
📊 **140 Repositories** in **7 Kategorien**  
🕐 **Letztes Update:** 2026-03-13 04:48:57  
🤖 **Generiert mit:** Atlassian CLI (ACLI) Rovo Dev

## 📂 Kategorien-Übersicht

- [Web Development](#web-development-55-repositories) (55 Repositories)
- [Other](#other-33-repositories) (33 Repositories)
- [Data Science & ML](#data-science--ml-28-repositories) (28 Repositories)
- [Mobile Development](#mobile-development-7-repositories) (7 Repositories)
...
**Details:** ⭐ 308437 `TypeScript` `ai`, `assistant`, `own-your-data`
...
**Details:** ⭐ 178903 `TypeScript` `automation`, `ipaas`, `n8n`
...
**Details:** ⭐ 39312 `TypeScript` `react`, `video`, `javascript`
...
**Details:** ⭐ 30007 `TypeScript` `spec`, `ai`, `context-engineering`
...
**Details:** ⭐ 23200 `TypeScript` `data-format`, `llm`, `serialization`
...
**Details:** ⭐ 20901 `TypeScript` `anthropic`, `anthropic-claude`, `claude`
...
**Details:** ⭐ 16617 `TypeScript` `ai-coding`, `vscode`, `vscode-extension`
...
**Details:** ⭐ 15021 `TypeScript` `claude-code`, `claude-desktop`, `codex`
...
**Details:** ⭐ 15012 `TypeScript` `cli`, `command`, `vercel`
...
**Details:** ⭐ 13636 `TypeScript` `ai`, `cursor`, `figma`
...
**Details:** ⭐ 13095 `JavaScript` `claude`, `codex`, `marketing`
...
**Details:** ⭐ 2484 `TypeScript` `deutsche-bahn`, `open-source`, `railway`
...
**Details:** ⭐ 846 `TypeScript` `drag-and-drop`, `homelab`, `rack`
...
**Details:** ⭐ 517 `TypeScript` `ai`, `artifacts`, `boilerplate`
...
**Details:** ⭐ 468 `TypeScript` `mcp`, `mcp-server`, `mermaid`
...
**Details:** ⭐ 386 `JavaScript` `claude`, `claudecode`, `databricks`
...
**Details:** ⭐ 379 `TypeScript` `cli`, `mcp`, `mcp-client`
...
**Details:** ⭐ 347 `TypeScript` `automation`, `build`, `filewatcher`
...
**Details:** ⭐ 20 `TypeScript` `ai-tools`, `claude-code`, `developer-tools`
...
**Details:** ⭐ 51835 `C#` `powershell`, `windows`, `macos`
...
**Details:** ⭐ 20582  `awesome-list`, `awesome`, `list`
...
**Details:** ⭐ 10655 `C#` `mremoteng`, `rdp`, `ssh`
...
**Details:** ⭐ 5348 `PowerShell` `powershell`, `windows-powershell`, `powershell-ise`
...
**Details:** ⭐ 3865  `awesome-list`, `internet-of-things`, `iot`
...
**Details:** ⭐ 2833 `PowerShell` `powershell`, `scripting`, `sccm`
...
**Details:** ⭐ 1376 `Svelte` `private-notes`, `privnote`, `secure-notes`
...
**Details:** ⭐ 461 `PowerShell` `crowdstrike`, `falcon`, `oauth2-client`
...
**Details:** ⭐ 76307 `Python` `ai`, `copilot`, `development`
...
**Details:** ⭐ 68321 `Python` `python`, `ansible`
...
**Details:** ⭐ 43513 `Python` `claude`, `claude-code`, `agent-skills`
...
**Details:** ⭐ 19659 `Rust` `google-workspace`, `agent-skills`, `ai-agent`
...
**Details:** ⭐ 10199 `Python` `honeypot`, `awesome-list`, `awesome`
...
**Details:** ⭐ 5599  `infosec`, `pentest`, `courses`
...
**Details:** ⭐ 4360 `Python` `python`, `ricing`, `status-bar`
...
**Details:** ⭐ 4165 `C#` `defender`, `firewall-configuration`, `harden`
...
**Details:** ⭐ 2539 `Python` `azure-active-directory`, `azuread`, `microsoft-graph`
...
**Details:** ⭐ 2273 `YAML` `apple`, `macos`, `compliance`
...
**Details:** ⭐ 2102  `ai`, `awesome`, `awesome-list`
...
**Details:** ⭐ 568 `Python` `agent-skills`, `opc`, `ai-tools`
...
## Mobile Development (7 Repositories)

### [Ice](https://github.com/jordanbaird/Ice)
Powerful menu bar manager for macOS

**Details:** ⭐ 26482 `Swift` `macos`, `menubar`, `statusbar`
...
**Details:** ⭐ 1557 `Swift` `claude`, `claude-ai`, `claude-code`
...
**Details:** ⭐ 75 `PowerShell` `laps`, `microsoft`, `windows`
...
**Details:** ⭐ 14192 `Rust` `tiling-window-manager`, `windows`, `rust`
...
**Details:** ⭐ 7340 `C++` `desktop`, `windows`, `xaml`
...
**Details:** ⭐ 3239 `C++` `logs`, `windows`, `linux`
...
**Details:** ⭐ 1981 `C` `openssh`, `openssh-server`, `windows`
...
**Details:** ⭐ 6050 `Groovy` `rundeck`, `devops`, `deployment`
...
**Details:** ⭐ 447 `Dockerfile` `hacktoberfest`
