...
📊 **164 Repositories** in **7 Kategorien**  
🕐 **Letztes Update:** 2026-04-12 05:29:09  
🤖 **Generiert mit:** Atlassian CLI (ACLI) Rovo Dev

## 📂 Kategorien-Übersicht

- [Web Development](#web-development-60-repositories) (60 Repositories)
- [Data Science & ML](#data-science--ml-38-repositories) (38 Repositories)
...
**Details:** ⭐ 355105 `TypeScript` `ai`, `assistant`, `own-your-data`
...
**Details:** ⭐ 183625 `TypeScript` `automation`, `ipaas`, `n8n`
...
**Details:** ⭐ 42779 `TypeScript` `react`, `video`, `javascript`
...
**Details:** ⭐ 39167 `TypeScript` `spec`, `ai`, `context-engineering`
...
**Details:** ⭐ 23781 `TypeScript` `data-format`, `llm`, `serialization`
...
**Details:** ⭐ 21418 `TypeScript` `anthropic`, `anthropic-claude`, `claude`
...
**Details:** ⭐ 20395 `JavaScript` `claude`, `codex`, `marketing`
...
**Details:** ⭐ 17973 `TypeScript` `ai-coding`, `vscode`, `vscode-extension`
...
**Details:** ⭐ 17726 `TypeScript` `claude-code`, `claude-desktop`, `codex`
...
**Details:** ⭐ 15265 `TypeScript` `cli`, `command`, `vercel`
...
**Details:** ⭐ 14280 `TypeScript` `ai`, `cursor`, `figma`
...
**Details:** ⭐ 2499 `TypeScript` `deutsche-bahn`, `open-source`, `railway`
...
**Details:** ⭐ 2349 `TypeScript` `customer-feedback`, `self-hosted`, `ruby-on-rails`
...
**Details:** ⭐ 1172 `TypeScript` `drag-and-drop`, `homelab`, `rack`
...
**Details:** ⭐ 527 `TypeScript` `ai`, `artifacts`, `boilerplate`
...
**Details:** ⭐ 516 `TypeScript` `mcp`, `mcp-server`, `mermaid`
...
**Details:** ⭐ 400 `JavaScript` `claude`, `claudecode`, `databricks`
...
**Details:** ⭐ 376 `TypeScript` `automation`, `build`, `filewatcher`
...
**Details:** ⭐ 85 `TypeScript` `deploy`, `deployment`, `docker`
...
## Data Science & ML (38 Repositories)

### [skills](https://github.com/anthropics/skills)
Public repository for Agent Skills

**Details:** ⭐ 115290 `Python` `agent-skills`
...
**Details:** ⭐ 87161 `Python` `ai`, `copilot`, `development`
...
**Details:** ⭐ 68348 `Python` `python`, `ansible`
...
**Details:** ⭐ 60542 `Python` `ai`, `ai-agent`, `ai-agents`
...
**Details:** ⭐ 53042 `Python` `claude`, `claude-code`, `agent-skills`
...
**Details:** ⭐ 42023 `Python` `ai`, `chromadb`, `llm`
...
**Details:** ⭐ 24430 `Rust` `google-workspace`, `agent-skills`, `ai-agent`
...
**Details:** ⭐ 23459 `Python` `agents`, `artificial-intelligence`, `cybersecurity`
...
**Details:** ⭐ 18990 `Python` `ai`, `anthropic`, `caveman`
...
**Details:** ⭐ 10224 `Python` `honeypot`, `awesome-list`, `awesome`
...
**Details:** ⭐ 5616  `infosec`, `pentest`, `courses`
...
**Details:** ⭐ 4602 `Python` `python`, `ricing`, `status-bar`
...
**Details:** ⭐ 4209 `C#` `defender`, `firewall-configuration`, `harden`
...
**Details:** ⭐ 2584 `Python` `azure-active-directory`, `azuread`, `microsoft-graph`
...
**Details:** ⭐ 2308 `YAML` `apple`, `macos`, `compliance`
...
**Details:** ⭐ 2101  `ai`, `awesome`, `awesome-list`
...
**Details:** ⭐ 1486 `Python` `agent-skills`, `ai`, `automation`
...
**Details:** ⭐ 702 `Python` `agent-skills`, `opc`, `ai-tools`
...
**Details:** ⭐ 52388 `C#` `powershell`, `windows`, `macos`
...
**Details:** ⭐ 20735  `awesome-list`, `awesome`, `list`
...
**Details:** ⭐ 5364 `PowerShell` `powershell`, `windows-powershell`, `powershell-ise`
...
**Details:** ⭐ 1391 `Svelte` `private-notes`, `privnote`, `secure-notes`
...
**Details:** ⭐ 27200 `Swift` `macos`, `menubar`, `statusbar`
...
**Details:** ⭐ 20636 `C++` `kodi`, `home-theater`, `media-center`
...
**Details:** ⭐ 17467 `Swift` `openemu`, `objective-c`, `macos`
...
**Details:** ⭐ 2011 `Swift` `claude`, `claude-ai`, `claude-code`
...
**Details:** ⭐ 219 `Swift` `audit`, `macos`, `macos-security`
...
**Details:** ⭐ 14387 `Rust` `tiling-window-manager`, `windows`, `rust`
...
**Details:** ⭐ 7416 `C++` `desktop`, `windows`, `xaml`
...
**Details:** ⭐ 3288 `C++` `logs`, `windows`, `linux`
...
**Details:** ⭐ 1996 `C` `openssh`, `openssh-server`, `windows`
...
**Details:** ⭐ 173 `Rust` `cmtrace`, `intune`
...
**Details:** ⭐ 6093 `Groovy` `rundeck`, `devops`, `deployment`
