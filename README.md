...
🕐 **Letztes Update:** 2026-05-11 06:44:02  
...
**Details:** ⭐ 370661 `TypeScript` `ai`, `assistant`, `own-your-data`
...
**Details:** ⭐ 187390 `TypeScript` `automation`, `ipaas`, `n8n`
...
**Details:** ⭐ 57729 `JavaScript` `ai`, `anthropic`, `caveman`
...
**Details:** ⭐ 46813 `TypeScript` `spec`, `ai`, `context-engineering`
...
**Details:** ⭐ 46477 `TypeScript` `react`, `video`, `javascript`
...
**Details:** ⭐ 36593 `TypeScript` `ai-agents`, `ai-design`, `byok`
...
**Details:** ⭐ 27743 `JavaScript` `claude`, `codex`, `marketing`
...
**Details:** ⭐ 24200 `TypeScript` `data-format`, `llm`, `serialization`
...
**Details:** ⭐ 21808 `TypeScript` `anthropic`, `anthropic-claude`, `claude`
...
**Details:** ⭐ 20486 `TypeScript` `claude-code`, `claude-desktop`, `codex`
...
**Details:** ⭐ 19154 `TypeScript` `ai-coding`, `vscode`, `vscode-extension`
...
**Details:** ⭐ 15459 `TypeScript` `cli`, `command`, `vercel`
...
**Details:** ⭐ 14699 `TypeScript` `ai`, `cursor`, `figma`
...
**Details:** ⭐ 8017 `TypeScript` `authoring`, `documentation`, `markdoc`
...
**Details:** ⭐ 5495 `TypeScript` `ai-design`, `anthropic`, `byok`
...
**Details:** ⭐ 4184 `TypeScript` `agentic-ai`, `antigravity`, `cerebras`
...
**Details:** ⭐ 1273 `TypeScript` `drag-and-drop`, `homelab`, `rack`
...
**Details:** ⭐ 595 `TypeScript` `cli`, `mcp`, `mcp-client`
...
**Details:** ⭐ 546 `TypeScript` `mcp`, `mcp-server`, `mermaid`
...
**Details:** ⭐ 394 `TypeScript` `automation`, `build`, `filewatcher`
...
**Details:** ⭐ 143094 `Python` `ai`, `ai-agent`, `ai-agents`
...
**Details:** ⭐ 131849 `Python` `agent-skills`
...
**Details:** ⭐ 95390 `Python` `ai`, `copilot`, `development`
...
**Details:** ⭐ 68501 `Python` `python`, `ansible`
...
**Details:** ⭐ 59136 `Python` `claude`, `claude-code`, `agent-skills`
...
**Details:** ⭐ 51894 `Python` `ai`, `chromadb`, `llm`
...
**Details:** ⭐ 27242 `Jupyter Notebook` `rag`, `tutorials`, `langchain`
...
**Details:** ⭐ 26045 `Rust` `google-workspace`, `agent-skills`, `ai-agent`
...
**Details:** ⭐ 25193 `Python` `agents`, `artificial-intelligence`, `cybersecurity`
...
**Details:** ⭐ 24897 `Python` `scraping`, `scraping-python`, `llm`
...
**Details:** ⭐ 10267 `Python` `honeypot`, `awesome-list`, `awesome`
...
**Details:** ⭐ 4834 `Python` `python`, `ricing`, `status-bar`
...
**Details:** ⭐ 2338 `YAML` `apple`, `macos`, `compliance`
...
**Details:** ⭐ 1763 `Python` `agent-skills`, `ai`, `automation`
...
**Details:** ⭐ 848 `Python` `agent-skills`, `opc`, `ai-tools`
...
**Details:** ⭐ 53368 `C#` `powershell`, `windows`, `macos`
...
**Details:** ⭐ 10793 `C#` `mremoteng`, `rdp`, `ssh`
...
**Details:** ⭐ 27856 `Swift` `macos`, `menubar`, `statusbar`
...
**Details:** ⭐ 20734 `C++` `kodi`, `home-theater`, `media-center`
...
**Details:** ⭐ 17539 `Swift` `openemu`, `objective-c`, `macos`
...
**Details:** ⭐ 2414 `Swift` `claude`, `claude-ai`, `claude-code`
...
**Details:** ⭐ 904 `PowerShell` `agent-skills`
...
**Details:** ⭐ 21423 `Rust` `speech-to-text`, `tauri-v2`, `accessibility`
...
**Details:** ⭐ 14523 `Rust` `tiling-window-manager`, `windows`, `rust`
...
**Details:** ⭐ 7507 `C++` `desktop`, `windows`, `xaml`
...
**Details:** ⭐ 4918 `Rust` `identity`, `identity-management`, `idm`
...
**Details:** ⭐ 190 `Rust` `cmtrace`, `intune`
...
**Details:** ⭐ 30272  `claude`, `codex`, `obsidian`
...
**Details:** ⭐ 54856 `PHP` `nodejs`, `mysql`, `php`
...
**Details:** ⭐ 6114 `Groovy` `rundeck`, `devops`, `deployment`
