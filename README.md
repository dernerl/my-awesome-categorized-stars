...
📊 **102 Repositories** in **22 Kategorien**  
🕐 **Letztes Update:** 2026-01-16 04:04:56  
🤖 **Generiert mit:** Atlassian CLI (ACLI) Rovo Dev

## 📂 Kategorien-Übersicht

- [AI & Machine Learning Tools](#ai--machine-learning-tools-15-repositories) (15 Repositories)
- [PowerShell Modules & Tools](#powershell-modules--tools-13-repositories) (13 Repositories)
- [Windows & Endpoint Management](#windows--endpoint-management-10-repositories) (10 Repositories)
- [Security & Hardening](#security--hardening-9-repositories) (9 Repositories)
- [Microsoft Intune & Azure](#microsoft-intune--azure-6-repositories) (6 Repositories)
- [DevOps & CI/CD](#devops--cicd-6-repositories) (6 Repositories)
- [CrowdStrike & Security Automation](#crowdstrike--security-automation-5-repositories) (5 Repositories)
- [Documentation & Diagramming](#documentation--diagramming-5-repositories) (5 Repositories)
- [MCP Servers & Integration](#mcp-servers--integration-4-repositories) (4 Repositories)
- [Remote Access & System Management](#remote-access--system-management-4-repositories) (4 Repositories)
- [Miscellaneous](#miscellaneous-4-repositories) (4 Repositories)
- [Workflow Automation](#workflow-automation-3-repositories) (3 Repositories)
...
- [macOS Tools](#macos-tools-2-repositories) (2 Repositories)
- [Logging & Monitoring](#logging--monitoring-2-repositories) (2 Repositories)
- [Privacy & Security Services](#privacy--security-services-2-repositories) (2 Repositories)
...
- [Windows UI & Desktop](#windows-ui--desktop-1-repositories) (1 Repositories)
...
## AI & Machine Learning Tools (15 Repositories)

### [spec-kit](https://github.com/github/spec-kit)
💫 Toolkit to help you get started with Spec-Driven Development

**Details:** ⭐ 62835 `Python` `ai`, `copilot`, `development`
...
**Details:** ⭐ 20007 `TypeScript` `anthropic`, `anthropic-claude`, `claude`
...
**Details:** ⭐ 17500 `TypeScript` `spec`, `ai`, `context-engineering`
...
**Details:** ⭐ 51 `TypeScript` `ai-tools`, `developer-tools`, `vibecoding`
...
## PowerShell Modules & Tools (13 Repositories)

### [PowerShell](https://github.com/PowerShell/PowerShell)
PowerShell for every system!

**Details:** ⭐ 51188 `C#` `powershell`, `windows`, `macos`
...
**Details:** ⭐ 5325 `PowerShell` `powershell`, `windows-powershell`, `powershell-ise`
...
**Details:** ⭐ 442 `Dockerfile` `hacktoberfest`
...
## Windows & Endpoint Management (10 Repositories)
...
## Security & Hardening (9 Repositories)

### [awesome-honeypots](https://github.com/paralax/awesome-honeypots)
an awesome list of honeypot resources

**Details:** ⭐ 10054 `Python` `honeypot`, `awesome-list`, `awesome`
...
**Details:** ⭐ 5556  `infosec`, `pentest`, `courses`
...
**Details:** ⭐ 3978 `C#` `defender`, `firewall-configuration`, `harden`
...
**Details:** ⭐ 2489 `Python` `azure-active-directory`, `azuread`, `microsoft-graph`
...
**Details:** ⭐ 2215 `YAML` `apple`, `macos`, `compliance`
...
## Microsoft Intune & Azure (6 Repositories)
...
**Details:** ⭐ 67663 `Python` `python`, `ansible`
...
**Details:** ⭐ 170 `PowerShell` `powershell`, `git-hooks`, `cicd`
...
## CrowdStrike & Security Automation (5 Repositories)
...
## Documentation & Diagramming (5 Repositories)
...
**Details:** ⭐ 369 `TypeScript` `mcp`, `mcp-server`, `mermaid`
...
## MCP Servers & Integration (4 Repositories)

### [servers](https://github.com/modelcontextprotocol/servers)
Model Context Protocol Servers

**Details:** ⭐ 76340 `TypeScript` 
...
**Details:** ⭐ 21862 `TypeScript` `data-format`, `llm`, `serialization`
...
**Details:** ⭐ 12556 `TypeScript` `ai`, `cursor`, `figma`
...
## Remote Access & System Management (4 Repositories)

### [komorebi](https://github.com/LGUG2Z/komorebi)
A tiling window manager for Windows 🍉

**Details:** ⭐ 13804 `Rust` `tiling-window-manager`, `windows`, `rust`
...
**Details:** ⭐ 10469 `C#` `mremoteng`, `rdp`, `ssh`
...
**Details:** ⭐ 2449 `TypeScript` `deutsche-bahn`, `open-source`, `railway`
...
**Details:** ⭐ 20282  `awesome-list`, `awesome`, `list`
...
## macOS Tools (2 Repositories)

### [Ice](https://github.com/jordanbaird/Ice)
Powerful menu bar manager for macOS

**Details:** ⭐ 25383 `Swift` `macos`, `menubar`, `statusbar`
...
**Details:** ⭐ 3168 `C++` `logs`, `windows`, `linux`
...
## Privacy & Security Services (2 Repositories)
...
**Details:** ⭐ 1314 `Svelte` `private-notes`, `privnote`, `secure-notes`
...
**Details:** ⭐ 3807  `awesome-list`, `internet-of-things`, `iot`
...
**Details:** ⭐ 16443 `TypeScript` `reactjs`, `tailwindcss`, `ui-system`
...
| Kategorie | Anzahl |
|-----------|--------|
| AI & Machine Learning Tools | 15 |
| PowerShell Modules & Tools | 13 |
| Windows & Endpoint Management | 10 |
| Security & Hardening | 9 |
| Microsoft Intune & Azure | 6 |
| DevOps & CI/CD | 6 |
| CrowdStrike & Security Automation | 5 |
| Documentation & Diagramming | 5 |
| MCP Servers & Integration | 4 |
| Remote Access & System Management | 4 |
| Miscellaneous | 4 |
