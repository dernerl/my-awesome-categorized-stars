...
🕐 **Letztes Update:** 2026-02-25 04:57:22  
...
**Details:** ⭐ 226014 `TypeScript` `ai`, `assistant`, `own-your-data`
...
**Details:** ⭐ 176223 `TypeScript` `automation`, `ipaas`, `n8n`
...
**Details:** ⭐ 25548 `TypeScript` `spec`, `ai`, `context-engineering`
...
**Details:** ⭐ 22802 `TypeScript` `data-format`, `llm`, `serialization`
...
**Details:** ⭐ 20670 `TypeScript` `anthropic`, `anthropic-claude`, `claude`
...
**Details:** ⭐ 15835 `TypeScript` `ai-coding`, `vscode`, `vscode-extension`
...
**Details:** ⭐ 14875 `TypeScript` `cli`, `command`, `vercel`
...
**Details:** ⭐ 13342 `TypeScript` `claude-code`, `claude-desktop`, `codex`
...
**Details:** ⭐ 13234 `TypeScript` `ai`, `cursor`, `figma`
...
**Details:** ⭐ 822 `TypeScript` `drag-and-drop`, `homelab`, `rack`
...
**Details:** ⭐ 450 `TypeScript` `mcp`, `mcp-server`, `mermaid`
...
**Details:** ⭐ 356 `JavaScript` `claude`, `claudecode`, `databricks`
...
**Details:** ⭐ 324 `TypeScript` `cli`, `mcp`, `mcp-client`
...
**Details:** ⭐ 51646 `C#` `powershell`, `windows`, `macos`
...
**Details:** ⭐ 20479  `awesome-list`, `awesome`, `list`
...
**Details:** ⭐ 10606 `C#` `mremoteng`, `rdp`, `ssh`
...
**Details:** ⭐ 3856  `awesome-list`, `internet-of-things`, `iot`
...
**Details:** ⭐ 2829 `PowerShell` `powershell`, `scripting`, `sccm`
...
**Details:** ⭐ 1527 `PowerShell` `devxsample`
...
**Details:** ⭐ 458 `PowerShell` `crowdstrike`, `falcon`, `oauth2-client`
...
**Details:** ⭐ 71791 `Python` `ai`, `copilot`, `development`
...
**Details:** ⭐ 68148 `Python` `python`, `ansible`
...
**Details:** ⭐ 10174 `Python` `honeypot`, `awesome-list`, `awesome`
...
**Details:** ⭐ 5590  `infosec`, `pentest`, `courses`
...
**Details:** ⭐ 4253 `Python` `python`, `ricing`, `status-bar`
...
**Details:** ⭐ 4147 `C#` `defender`, `firewall-configuration`, `harden`
...
**Details:** ⭐ 2255 `YAML` `apple`, `macos`, `compliance`
...
**Details:** ⭐ 2099  `ai`, `awesome`, `awesome-list`
...
**Details:** ⭐ 474 `Python` `crowdstrike`, `oauth2`, `falconpy`
...
**Details:** ⭐ 26131 `Swift` `macos`, `menubar`, `statusbar`
...
**Details:** ⭐ 1293 `Swift` `claude`, `claude-ai`, `claude-code`
...
**Details:** ⭐ 71 `PowerShell` `laps`, `microsoft`, `windows`
...
**Details:** ⭐ 14109 `Rust` `tiling-window-manager`, `windows`, `rust`
...
**Details:** ⭐ 7297 `C++` `desktop`, `windows`, `xaml`
...
**Details:** ⭐ 3221 `C++` `logs`, `windows`, `linux`
...
**Details:** ⭐ 6038 `Groovy` `rundeck`, `devops`, `deployment`
