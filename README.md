...
🕐 **Letztes Update:** 2026-05-06 06:10:00  
...
**Details:** ⭐ 368770 `TypeScript` `ai`, `assistant`, `own-your-data`
...
**Details:** ⭐ 186821 `TypeScript` `automation`, `ipaas`, `n8n`
...
**Details:** ⭐ 45889 `TypeScript` `react`, `video`, `javascript`
...
**Details:** ⭐ 45474 `TypeScript` `spec`, `ai`, `context-engineering`
...
**Details:** ⭐ 26811 `JavaScript` `claude`, `codex`, `marketing`
...
**Details:** ⭐ 24125 `TypeScript` `data-format`, `llm`, `serialization`
...
**Details:** ⭐ 21739 `TypeScript` `anthropic`, `anthropic-claude`, `claude`
...
**Details:** ⭐ 20111 `TypeScript` `claude-code`, `claude-desktop`, `codex`
...
**Details:** ⭐ 18954 `TypeScript` `ai-coding`, `vscode`, `vscode-extension`
...
**Details:** ⭐ 15422 `TypeScript` `cli`, `command`, `vercel`
...
**Details:** ⭐ 14627 `TypeScript` `ai`, `cursor`, `figma`
...
**Details:** ⭐ 8012 `TypeScript` `authoring`, `documentation`, `markdoc`
...
**Details:** ⭐ 4863 `TypeScript` `ai-design`, `anthropic`, `byok`
...
**Details:** ⭐ 1257 `TypeScript` `drag-and-drop`, `homelab`, `rack`
...
**Details:** ⭐ 572 `TypeScript` `cli`, `mcp`, `mcp-client`
...
**Details:** ⭐ 134607 `Python` `ai`, `ai-agent`, `ai-agents`
...
**Details:** ⭐ 128675 `Python` `agent-skills`
...
**Details:** ⭐ 92735 `Python` `ai`, `copilot`, `development`
...
**Details:** ⭐ 68466 `Python` `python`, `ansible`
...
**Details:** ⭐ 58187 `Python` `claude`, `claude-code`, `agent-skills`
...
**Details:** ⭐ 54698 `Python` `ai`, `anthropic`, `caveman`
...
**Details:** ⭐ 51258 `Python` `ai`, `chromadb`, `llm`
...
**Details:** ⭐ 27148 `Jupyter Notebook` `rag`, `tutorials`, `langchain`
...
**Details:** ⭐ 25798 `Rust` `google-workspace`, `agent-skills`, `ai-agent`
...
**Details:** ⭐ 24952 `Python` `agents`, `artificial-intelligence`, `cybersecurity`
...
**Details:** ⭐ 10257 `Python` `honeypot`, `awesome-list`, `awesome`
...
**Details:** ⭐ 5653  `infosec`, `pentest`, `courses`
...
**Details:** ⭐ 4775 `Python` `python`, `ricing`, `status-bar`
...
**Details:** ⭐ 2600 `Python` `azure-active-directory`, `azuread`, `microsoft-graph`
...
**Details:** ⭐ 1720 `Python` `agent-skills`, `ai`, `automation`
...
**Details:** ⭐ 838 `Python` `agent-skills`, `opc`, `ai-tools`
...
**Details:** ⭐ 53301 `C#` `powershell`, `windows`, `macos`
...
**Details:** ⭐ 20867  `awesome-list`, `awesome`, `list`
...
**Details:** ⭐ 3925  `awesome-list`, `internet-of-things`, `iot`
...
**Details:** ⭐ 1410 `Svelte` `private-notes`, `privnote`, `secure-notes`
...
**Details:** ⭐ 27773 `Swift` `macos`, `menubar`, `statusbar`
...
**Details:** ⭐ 20720 `C++` `kodi`, `home-theater`, `media-center`
...
**Details:** ⭐ 17526 `Swift` `openemu`, `objective-c`, `macos`
...
**Details:** ⭐ 2369 `Swift` `claude`, `claude-ai`, `claude-code`
...
**Details:** ⭐ 845 `PowerShell` `agent-skills`
...
**Details:** ⭐ 21174 `Rust` `speech-to-text`, `tauri-v2`, `accessibility`
...
**Details:** ⭐ 7478 `C++` `desktop`, `windows`, `xaml`
...
**Details:** ⭐ 3325 `C++` `logs`, `windows`, `linux`
...
**Details:** ⭐ 187 `Rust` `cmtrace`, `intune`
...
**Details:** ⭐ 29106  `claude`, `codex`, `obsidian`
...
**Details:** ⭐ 54620 `PHP` `nodejs`, `mysql`, `php`
