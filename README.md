...
🕐 **Letztes Update:** 2026-05-27 07:08:50  
...
**Details:** ⭐ 374953 `TypeScript` `ai`, `assistant`, `own-your-data`
...
**Details:** ⭐ 189866 `TypeScript` `automation`, `ipaas`, `n8n`
...
**Details:** ⭐ 124072 `TypeScript` `productivity`, `collaboration`, `diagrams`
...
**Details:** ⭐ 65282 `JavaScript` `ai`, `anthropic`, `caveman`
...
**Details:** ⭐ 53204 `TypeScript` `ai-agents`, `ai-design`, `byok`
...
**Details:** ⭐ 51040 `TypeScript` `spec`, `ai`, `context-engineering`
...
**Details:** ⭐ 48158 `TypeScript` `react`, `video`, `javascript`
...
**Details:** ⭐ 30673 `JavaScript` `claude`, `codex`, `marketing`
...
**Details:** ⭐ 24388 `TypeScript` `data-format`, `llm`, `serialization`
...
**Details:** ⭐ 21953 `TypeScript` `anthropic`, `anthropic-claude`, `claude`
...
**Details:** ⭐ 21250 `TypeScript` `claude-code`, `claude-desktop`, `codex`
...
**Details:** ⭐ 19619 `TypeScript` `ai-coding`, `vscode`, `vscode-extension`
...
**Details:** ⭐ 15545 `TypeScript` `cli`, `command`, `vercel`
...
**Details:** ⭐ 14884 `TypeScript` `ai`, `cursor`, `figma`
...
**Details:** ⭐ 6450 `TypeScript` `ai-design`, `anthropic`, `byok`
...
**Details:** ⭐ 4793 `TypeScript` `agentic-ai`, `antigravity`, `cerebras`
...
**Details:** ⭐ 1318 `TypeScript` `drag-and-drop`, `homelab`, `rack`
...
**Details:** ⭐ 567 `TypeScript` `mcp`, `mcp-server`, `mermaid`
...
**Details:** ⭐ 424 `JavaScript` `claude`, `claudecode`, `databricks`
...
**Details:** ⭐ 403 `TypeScript` `automation`, `build`, `filewatcher`
...
**Details:** ⭐ 51 `TypeScript` `ai-tools`, `claude-code`, `developer-tools`
...
**Details:** ⭐ 169242 `Python` `ai`, `ai-agent`, `ai-agents`
...
**Details:** ⭐ 141506 `Python` `agent-skills`
...
**Details:** ⭐ 106260 `Python` `ai`, `copilot`, `development`
...
**Details:** ⭐ 68694 `Python` `python`, `ansible`
...
**Details:** ⭐ 62029 `Python` `claude`, `claude-code`, `agent-skills`
...
**Details:** ⭐ 52895 `Python` `ai`, `chromadb`, `llm`
...
**Details:** ⭐ 27577 `Jupyter Notebook` `rag`, `tutorials`, `langchain`
...
**Details:** ⭐ 26600 `Rust` `google-workspace`, `agent-skills`, `ai-agent`
...
**Details:** ⭐ 26172 `Python` `scraping`, `scraping-python`, `llm`
...
**Details:** ⭐ 25632 `Python` `agents`, `artificial-intelligence`, `cybersecurity`
...
**Details:** ⭐ 10298 `Python` `honeypot`, `awesome-list`, `awesome`
...
**Details:** ⭐ 5676  `infosec`, `pentest`, `courses`
...
**Details:** ⭐ 4958 `Python` `python`, `ricing`, `status-bar`
...
**Details:** ⭐ 4299 `C#` `defender`, `firewall-configuration`, `harden`
...
**Details:** ⭐ 2618 `Python` `azure-active-directory`, `azuread`, `microsoft-graph`
...
**Details:** ⭐ 2357 `YAML` `apple`, `macos`, `compliance`
...
**Details:** ⭐ 1896 `Python` `agent-skills`, `ai`, `automation`
...
**Details:** ⭐ 53618 `C#` `powershell`, `windows`, `macos`
...
**Details:** ⭐ 20950  `awesome-list`, `awesome`, `list`
...
**Details:** ⭐ 10832 `C#` `mremoteng`, `rdp`, `ssh`
...
**Details:** ⭐ 3969  `disaster-response`, `disaster-management`
...
**Details:** ⭐ 2856 `PowerShell` `powershell`, `scripting`, `sccm`
...
**Details:** ⭐ 28136 `Swift` `macos`, `menubar`, `statusbar`
...
**Details:** ⭐ 20785 `C++` `kodi`, `home-theater`, `media-center`
...
**Details:** ⭐ 17569 `Swift` `openemu`, `objective-c`, `macos`
...
**Details:** ⭐ 2549 `Swift` `claude`, `claude-ai`, `claude-code`
...
**Details:** ⭐ 1091 `PowerShell` `agent-skills`
...
**Details:** ⭐ 22433 `Rust` `speech-to-text`, `tauri-v2`, `accessibility`
...
**Details:** ⭐ 14649 `Rust` `tiling-window-manager`, `windows`, `rust`
...
**Details:** ⭐ 7612 `C++` `desktop`, `windows`, `xaml`
...
**Details:** ⭐ 4993 `Rust` `identity`, `identity-management`, `idm`
...
**Details:** ⭐ 197 `Rust` `cmtrace`, `intune`
...
**Details:** ⭐ 33196  `claude`, `codex`, `obsidian`
...
**Details:** ⭐ 56070 `PHP` `nodejs`, `mysql`, `php`
...
**Details:** ⭐ 6123 `Groovy` `rundeck`, `devops`, `deployment`
