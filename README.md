...
📊 **105 Repositories** in **28 Kategorien**  
🕐 **Letztes Update:** 2026-01-23 04:07:34  
🤖 **Generiert mit:** Atlassian CLI (ACLI) Rovo Dev

## 📂 Kategorien-Übersicht

- [PowerShell Modules & Scripts](#powershell-modules--scripts-12-repositories) (12 Repositories)
- [Security & Compliance](#security--compliance-9-repositories) (9 Repositories)
- [AI & Machine Learning Tools](#ai--machine-learning-tools-8-repositories) (8 Repositories)
- [AI-Assisted Development & Spec-Driven Development](#ai-assisted-development--spec-driven-development-7-repositories) (7 Repositories)
- [Model Context Protocol (MCP) Servers](#model-context-protocol-mcp-servers-6-repositories) (6 Repositories)
- [Microsoft Security & Identity Management](#microsoft-security--identity-management-5-repositories) (5 Repositories)
- [Intune & Endpoint Management](#intune--endpoint-management-5-repositories) (5 Repositories)
- [Windows Administration & Tools](#windows-administration--tools-5-repositories) (5 Repositories)
- [Miscellaneous Tools](#miscellaneous-tools-5-repositories) (5 Repositories)
- [Workflow Automation & Integration](#workflow-automation--integration-4-repositories) (4 Repositories)
- [CrowdStrike Falcon](#crowdstrike-falcon-4-repositories) (4 Repositories)
- [macOS Tools & Utilities](#macos-tools--utilities-4-repositories) (4 Repositories)
- [Awesome Lists & Resources](#awesome-lists--resources-4-repositories) (4 Repositories)
- [Citrix & VDI](#citrix--vdi-3-repositories) (3 Repositories)
- [Microsoft 365 & Office](#microsoft-365--office-3-repositories) (3 Repositories)
- [Documentation Tools](#documentation-tools-3-repositories) (3 Repositories)
- [Active Directory & LDAP](#active-directory--ldap-2-repositories) (2 Repositories)
- [Remote Access & Monitoring](#remote-access--monitoring-2-repositories) (2 Repositories)
- [DevOps & CI/CD](#devops--cicd-2-repositories) (2 Repositories)
- [UI Components & Design Systems](#ui-components--design-systems-2-repositories) (2 Repositories)
...
- [Microsoft Teams](#microsoft-teams-1-repositories) (1 Repositories)
...
- [Web3 & Blockchain](#web3--blockchain-1-repositories) (1 Repositories)
- [Browser Extensions](#browser-extensions-1-repositories) (1 Repositories)
- [Secure Boot & System Objects](#secure-boot--system-objects-1-repositories) (1 Repositories)


---

## PowerShell Modules & Scripts (12 Repositories)

### [PowerShell](https://github.com/PowerShell/PowerShell)
PowerShell for every system!

**Details:** ⭐ 51246 `C#` `powershell`, `windows`, `macos`
...
**Details:** ⭐ 5330 `PowerShell` `powershell`, `windows-powershell`, `powershell-ise`
...
**Details:** ⭐ 1957 `C` `openssh`, `openssh-server`, `windows`
...
**Details:** ⭐ 443 `Dockerfile` `hacktoberfest`
...
**Details:** ⭐ 171 `PowerShell` `powershell`, `git-hooks`, `cicd`
...
**Details:** ⭐ 10080 `Python` `honeypot`, `awesome-list`, `awesome`
...
**Details:** ⭐ 5565  `infosec`, `pentest`, `courses`
...
**Details:** ⭐ 4008 `C#` `defender`, `firewall-configuration`, `harden`
...
**Details:** ⭐ 2223 `YAML` `apple`, `macos`, `compliance`
...
**Details:** ⭐ 158 `PowerShell` `audit`, `compliance`, `cis`
...
**Details:** ⭐ 38 `Go` `automation`, `compliance`, `grc`
...
## AI & Machine Learning Tools (8 Repositories)
...
**Details:** ⭐ 20139 `TypeScript` `anthropic`, `anthropic-claude`, `claude`
...
## AI-Assisted Development & Spec-Driven Development (7 Repositories)

### [spec-kit](https://github.com/github/spec-kit)
💫 Toolkit to help you get started with Spec-Driven Development

**Details:** ⭐ 64491 `Python` `ai`, `copilot`, `development`
...
**Details:** ⭐ 19099 `TypeScript` `spec`, `ai`, `context-engineering`
...
**Details:** ⭐ 52 `TypeScript` `ai-tools`, `developer-tools`, `vibecoding`

---

## Model Context Protocol (MCP) Servers (6 Repositories)

### [servers](https://github.com/modelcontextprotocol/servers)
Model Context Protocol Servers

**Details:** ⭐ 76933 `TypeScript` 
...
**Details:** ⭐ 12675 `TypeScript` `ai`, `cursor`, `figma`
...
**Details:** ⭐ 375 `TypeScript` `mcp`, `mcp-server`, `mermaid`
...
**Details:** ⭐ 11 `TypeScript` 

---

## Microsoft Security & Identity Management (5 Repositories)

### [ROADtools](https://github.com/dirkjanm/ROADtools)
A collection of Azure AD/Entra tools for offensive and defensive security purposes

**Details:** ⭐ 2499 `Python` `azure-active-directory`, `azuread`, `microsoft-graph`
...
## Intune & Endpoint Management (5 Repositories)
...
**Details:** ⭐ 1515 `PowerShell` `devxsample`
...
## Windows Administration & Tools (5 Repositories)

### [komorebi](https://github.com/LGUG2Z/komorebi)
A tiling window manager for Windows 🍉

**Details:** ⭐ 13868 `Rust` `tiling-window-manager`, `windows`, `rust`
...
**Details:** ⭐ 60 `PowerShell` `laps`, `microsoft`, `windows`
...
## Miscellaneous Tools (5 Repositories)
...
**Details:** ⭐ 2455 `TypeScript` `deutsche-bahn`, `open-source`, `railway`
...
**Details:** ⭐ 170730 `TypeScript` `automation`, `ipaas`, `n8n`
...
**Details:** ⭐ 67748 `Python` `python`, `ansible`
...
## CrowdStrike Falcon (4 Repositories)

### [falconpy](https://github.com/CrowdStrike/falconpy)
The CrowdStrike Falcon SDK for Python

**Details:** ⭐ 462 `Python` `crowdstrike`, `oauth2`, `falconpy`
...
## macOS Tools & Utilities (4 Repositories)

### [Ice](https://github.com/jordanbaird/Ice)
Powerful menu bar manager for macOS

**Details:** ⭐ 25518 `Swift` `macos`, `menubar`, `statusbar`
...
**Details:** ⭐ 52 `Swift` `icns`, `icon`, `command-line`

---

## Awesome Lists & Resources (4 Repositories)
...
**Details:** ⭐ 20321  `awesome-list`, `awesome`, `list`
...
## Documentation Tools (3 Repositories)
...
## Active Directory & LDAP (2 Repositories)

### [Public-AD-Scripts](https://github.com/zjorz/Public-AD-Scripts)
AD Scripts

**Details:** ⭐ 417 `PowerShell` 
...
## Remote Access & Monitoring (2 Repositories)
...
**Details:** ⭐ 10500 `C#` `mremoteng`, `rdp`, `ssh`
...
**Details:** ⭐ 3176 `C++` `logs`, `windows`, `linux`

---

## DevOps & CI/CD (2 Repositories)
...
## UI Components & Design Systems (2 Repositories)

### [tremor-npm](https://github.com/tremorlabs/tremor-npm)
React components to build charts and dashboards

**Details:** ⭐ 16450 `TypeScript` `reactjs`, `tailwindcss`, `ui-system`
...
**Details:** ⭐ 7240 `C++` `desktop`, `windows`, `xaml`
...
**Details:** ⭐ 1319 `Svelte` `private-notes`, `privnote`, `secure-notes`
...
**Details:** ⭐ 3819  `awesome-list`, `internet-of-things`, `iot`
...
## Microsoft Teams (1 Repositories)
...
**Details:** ⭐ 2345 `TypeScript` `customer-feedback`, `self-hosted`, `ruby-on-rails`
...
**Details:** ⭐ 22076 `TypeScript` `data-format`, `llm`, `serialization`

---

## Web3 & Blockchain (1 Repositories)
...
## Browser Extensions (1 Repositories)

### [OneClick](https://github.com/arifszn/OneClick)
Navigate to your favorite actions on the websites you love with just one click.

**Details:** ⭐ 95 `JavaScript` `shortcuts`, `new`, `create-new-item`

---

## Secure Boot & System Objects (1 Repositories)
...
| Kategorie | Anzahl |
|-----------|--------|
| PowerShell Modules & Scripts | 12 |
| Security & Compliance | 9 |
| AI & Machine Learning Tools | 8 |
| AI-Assisted Development & Spec-Driven Development | 7 |
| Model Context Protocol (MCP) Servers | 6 |
| Microsoft Security & Identity Management | 5 |
| Intune & Endpoint Management | 5 |
| Windows Administration & Tools | 5 |
| Miscellaneous Tools | 5 |
| Workflow Automation & Integration | 4 |
| CrowdStrike Falcon | 4 |
| macOS Tools & Utilities | 4 |
| Awesome Lists & Resources | 4 |
| Citrix & VDI | 3 |
| Microsoft 365 & Office | 3 |
| Documentation Tools | 3 |
| Active Directory & LDAP | 2 |
| Remote Access & Monitoring | 2 |
| DevOps & CI/CD | 2 |
| UI Components & Design Systems | 2 |
...
| Secure Boot & System Objects | 1 |

**Gesamt:** 105 Repositories
