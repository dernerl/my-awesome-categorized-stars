...
🕐 **Letztes Update:** 2026-02-27 04:49:34  
...
**Details:** ⭐ 233816 `TypeScript` `ai`, `assistant`, `own-your-data`
...
**Details:** ⭐ 176589 `TypeScript` `automation`, `ipaas`, `n8n`
...
**Details:** ⭐ 26074 `TypeScript` `spec`, `ai`, `context-engineering`
...
**Details:** ⭐ 22876 `TypeScript` `data-format`, `llm`, `serialization`
...
**Details:** ⭐ 20694 `TypeScript` `anthropic`, `anthropic-claude`, `claude`
...
**Details:** ⭐ 16460 `TypeScript` `reactjs`, `tailwindcss`, `ui-system`
...
**Details:** ⭐ 15960 `TypeScript` `ai-coding`, `vscode`, `vscode-extension`
...
**Details:** ⭐ 14898 `TypeScript` `cli`, `command`, `vercel`
...
**Details:** ⭐ 13681 `TypeScript` `claude-code`, `claude-desktop`, `codex`
...
**Details:** ⭐ 13271 `TypeScript` `ai`, `cursor`, `figma`
...
**Details:** ⭐ 825 `TypeScript` `drag-and-drop`, `homelab`, `rack`
...
**Details:** ⭐ 359 `JavaScript` `claude`, `claudecode`, `databricks`
...
**Details:** ⭐ 327 `TypeScript` `cli`, `mcp`, `mcp-client`
...
**Details:** ⭐ 35  `automation`, `crypto`, `defi`
...
**Details:** ⭐ 51668 `C#` `powershell`, `windows`, `macos`
...
**Details:** ⭐ 20495  `awesome-list`, `awesome`, `list`
...
**Details:** ⭐ 10614 `C#` `mremoteng`, `rdp`, `ssh`
...
**Details:** ⭐ 3858  `awesome-list`, `internet-of-things`, `iot`
...
**Details:** ⭐ 1341 `Svelte` `private-notes`, `privnote`, `secure-notes`
...
**Details:** ⭐ 72390 `Python` `ai`, `copilot`, `development`
...
**Details:** ⭐ 4265 `Python` `python`, `ricing`, `status-bar`
...
**Details:** ⭐ 2529 `Python` `azure-active-directory`, `azuread`, `microsoft-graph`
...
**Details:** ⭐ 26186 `Swift` `macos`, `menubar`, `statusbar`
...
**Details:** ⭐ 1321 `Swift` `claude`, `claude-ai`, `claude-code`
...
**Details:** ⭐ 14117 `Rust` `tiling-window-manager`, `windows`, `rust`
...
**Details:** ⭐ 7301 `C++` `desktop`, `windows`, `xaml`
...
**Details:** ⭐ 3223 `C++` `logs`, `windows`, `linux`
...
**Details:** ⭐ 6040 `Groovy` `rundeck`, `devops`, `deployment`
