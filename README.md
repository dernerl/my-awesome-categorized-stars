...
📊 **72 Repositories** in **10 Kategorien**  
🕐 **Letztes Update:** 2025-11-16 03:51:22  
🤖 **Generiert mit:** Atlassian CLI (ACLI) Rovo Dev

## 📂 Kategorien-Übersicht

- [Microsoft 365 & Azure](#microsoft-365--azure-14-repositories) (14 Repositories)
- [AI & Machine Learning](#ai--machine-learning-10-repositories) (10 Repositories)
- [System Administration & IT Tools](#system-administration--it-tools-10-repositories) (10 Repositories)
- [Security & Compliance](#security--compliance-9-repositories) (9 Repositories)
- [PowerShell Development](#powershell-development-8-repositories) (8 Repositories)
...
- [Awesome Lists & Collections](#awesome-lists--collections-4-repositories) (4 Repositories)
- [Development Tools & Resources](#development-tools--resources-3-repositories) (3 Repositories)
- [Blockchain & Cryptocurrency](#blockchain--cryptocurrency-1-repositories) (1 Repositories)


---

## Microsoft 365 & Azure (14 Repositories)

### [ROADtools](https://github.com/dirkjanm/ROADtools)
A collection of Azure AD/Entra tools for offensive and defensive security purposes

**Details:** ⭐ 2452 `Python` `azure-active-directory`, `azuread`, `microsoft-graph`
...
**Details:** ⭐ 1492 `PowerShell` `devxsample`
...
**Details:** ⭐ 16258 `TypeScript` `data-format`, `llm`, `serialization`
...
**Details:** ⭐ 11797 `TypeScript` `ai`, `cursor`, `figma`
...
## System Administration & IT Tools (10 Repositories)

### [komorebi](https://github.com/LGUG2Z/komorebi)
A tiling window manager for Windows 🍉

**Details:** ⭐ 13263 `Rust` `tiling-window-manager`, `windows`, `rust`
...
**Details:** ⭐ 10308 `C#` `mremoteng`, `rdp`, `ssh`
...
**Details:** ⭐ 502 `PowerShell` `winforms`, `powershell`, `gui`
...
**Details:** ⭐ 9846 `Python` `honeypot`, `awesome-list`, `awesome`
...
**Details:** ⭐ 5507  `infosec`, `pentest`, `courses`
...
**Details:** ⭐ 2155 `YAML` `apple`, `macos`, `compliance`
...
**Details:** ⭐ 1189 `Svelte` `private-notes`, `privnote`, `secure-notes`
...
## PowerShell Development (8 Repositories)

### [PowerShell](https://github.com/PowerShell/PowerShell)
PowerShell for every system!

**Details:** ⭐ 50774 `C#` `powershell`, `windows`, `macos`
...
**Details:** ⭐ 5271 `PowerShell` `powershell`, `windows-powershell`, `powershell-ise`
...
**Details:** ⭐ 2371 `TypeScript` `deutsche-bahn`, `open-source`, `railway`
...
**Details:** ⭐ 92 `JavaScript` `shortcuts`, `new`, `create-new-item`
...
## Awesome Lists & Collections (4 Repositories)
...
**Details:** ⭐ 20034  `awesome-list`, `awesome`, `list`
...
**Details:** ⭐ 3604  `awesome-list`, `internet-of-things`, `iot`
...
**Details:** ⭐ 1507 `PowerShell` `stencils`, `stencils-pack`, `mis-azure`
...
| Kategorie | Anzahl |
|-----------|--------|
| Microsoft 365 & Azure | 14 |
| AI & Machine Learning | 10 |
| System Administration & IT Tools | 10 |
| Security & Compliance | 9 |
| PowerShell Development | 8 |
| Web Development & UI | 7 |
| DevOps & Automation | 6 |
| Awesome Lists & Collections | 4 |
| Development Tools & Resources | 3 |
