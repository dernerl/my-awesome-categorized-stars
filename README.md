...
📊 **109 Repositories** in **31 Kategorien**  
🕐 **Letztes Update:** 2026-01-28 04:09:36  
🤖 **Generiert mit:** Atlassian CLI (ACLI) Rovo Dev

## 📂 Kategorien-Übersicht

- [PowerShell Modules & Tools](#powershell-modules--tools-12-repositories) (12 Repositories)
- [AI Development Tools](#ai-development-tools-10-repositories) (10 Repositories)
- [Security & Compliance](#security--compliance-9-repositories) (9 Repositories)
- [Windows Administration](#windows-administration-7-repositories) (7 Repositories)
- [AI Integration & MCP Servers](#ai-integration--mcp-servers-6-repositories) (6 Repositories)
- [Microsoft 365 & Azure](#microsoft-365--azure-6-repositories) (6 Repositories)
- [AI & Machine Learning](#ai--machine-learning-5-repositories) (5 Repositories)
- [Security Monitoring & Response](#security-monitoring--response-5-repositories) (5 Repositories)
- [macOS Tools](#macos-tools-5-repositories) (5 Repositories)
- [DevOps & CI/CD](#devops--cicd-4-repositories) (4 Repositories)
- [Automation & Workflow](#automation--workflow-4-repositories) (4 Repositories)
- [Windows Management](#windows-management-3-repositories) (3 Repositories)
- [Communication & Chat](#communication--chat-3-repositories) (3 Repositories)
- [Miscellaneous](#miscellaneous-3-repositories) (3 Repositories)
- [Microsoft Intune & MDM](#microsoft-intune--mdm-2-repositories) (2 Repositories)
- [Identity & Access Management](#identity--access-management-2-repositories) (2 Repositories)
- [Infrastructure & Cloud](#infrastructure--cloud-2-repositories) (2 Repositories)
- [UI Components & Design Systems](#ui-components--design-systems-2-repositories) (2 Repositories)
- [Documentation Tools](#documentation-tools-2-repositories) (2 Repositories)
- [Cryptography & Privacy](#cryptography--privacy-2-repositories) (2 Repositories)
- [IoT & Hardware](#iot--hardware-2-repositories) (2 Repositories)
- [Security Resources](#security-resources-2-repositories) (2 Repositories)
- [System Administration](#system-administration-2-repositories) (2 Repositories)
- [Developer Resources](#developer-resources-2-repositories) (2 Repositories)
- [Remote Desktop & Access](#remote-desktop--access-1-repositories) (1 Repositories)
- [Monitoring & Logging](#monitoring--logging-1-repositories) (1 Repositories)
...
- [Security Analytics](#security-analytics-1-repositories) (1 Repositories)
...
## PowerShell Modules & Tools (12 Repositories)

### [PowerShell](https://github.com/PowerShell/PowerShell)
PowerShell for every system!

**Details:** ⭐ 51273 `C#` `powershell`, `windows`, `macos`
...
**Details:** ⭐ 5332 `PowerShell` `powershell`, `windows-powershell`, `powershell-ise`
...
**Details:** ⭐ 1961 `C` `openssh`, `openssh-server`, `windows`
...
## AI Development Tools (10 Repositories)

### [spec-kit](https://github.com/github/spec-kit)
💫 Toolkit to help you get started with Spec-Driven Development

**Details:** ⭐ 65680 `Python` `ai`, `copilot`, `development`
...
**Details:** ⭐ 20239 `TypeScript` `anthropic`, `anthropic-claude`, `claude`
...
**Details:** ⭐ 20180 `TypeScript` `spec`, `ai`, `context-engineering`
...
**Details:** ⭐ 4022 `C#` `defender`, `firewall-configuration`, `harden`
...
**Details:** ⭐ 2504 `Python` `azure-active-directory`, `azuread`, `microsoft-graph`
...
**Details:** ⭐ 2228 `YAML` `apple`, `macos`, `compliance`
...
**Details:** ⭐ 160 `PowerShell` `audit`, `compliance`, `cis`
...
## Windows Administration (7 Repositories)
...
**Details:** ⭐ 61 `PowerShell` `laps`, `microsoft`, `windows`
...
**Details:** ⭐ 12841 `TypeScript` `ai`, `cursor`, `figma`
...
**Details:** ⭐ 384 `TypeScript` `mcp`, `mcp-server`, `mermaid`
...
## Microsoft 365 & Azure (6 Repositories)
...
## AI & Machine Learning (5 Repositories)

### [flux](https://github.com/black-forest-labs/flux)
Official inference repo for FLUX.1 models

**Details:** ⭐ 25149 `Python` 
...
**Details:** ⭐ 85 `Python` `agent`, `agents`, `ai`
...
## Security Monitoring & Response (5 Repositories)

### [falconpy](https://github.com/CrowdStrike/falconpy)
The CrowdStrike Falcon SDK for Python

**Details:** ⭐ 466 `Python` `crowdstrike`, `oauth2`, `falconpy`
...
**Details:** ⭐ 448 `PowerShell` `crowdstrike`, `falcon`, `oauth2-client`
...
## macOS Tools (5 Repositories)

### [Ice](https://github.com/jordanbaird/Ice)
Powerful menu bar manager for macOS

**Details:** ⭐ 25637 `Swift` `macos`, `menubar`, `statusbar`
...
## Automation & Workflow (4 Repositories)
...
**Details:** ⭐ 67808 `Python` `python`, `ansible`
...
## Windows Management (3 Repositories)

### [komorebi](https://github.com/LGUG2Z/komorebi)
A tiling window manager for Windows 🍉

**Details:** ⭐ 13903 `Rust` `tiling-window-manager`, `windows`, `rust`
...
## Communication & Chat (3 Repositories)
...
## Miscellaneous (3 Repositories)

### [BMAD-METHOD](https://github.com/bmad-code-org/BMAD-METHOD)
Breakthrough Method for Agile Ai Driven Development

**Details:** ⭐ 32364 `JavaScript` 
...
**Details:** ⭐ 2456 `TypeScript` `deutsche-bahn`, `open-source`, `railway`
...
**Details:** ⭐ 104 `TypeScript` 

---

## Microsoft Intune & MDM (2 Repositories)
...
**Details:** ⭐ 1518 `PowerShell` `devxsample`
...
## Identity & Access Management (2 Repositories)
...
## Infrastructure & Cloud (2 Repositories)
...
**Details:** ⭐ 16449 `TypeScript` `reactjs`, `tailwindcss`, `ui-system`
...
**Details:** ⭐ 7251 `C++` `desktop`, `windows`, `xaml`

---

## Documentation Tools (2 Repositories)
...
## Cryptography & Privacy (2 Repositories)
...
**Details:** ⭐ 1323 `Svelte` `private-notes`, `privnote`, `secure-notes`
...
**Details:** ⭐ 3823  `awesome-list`, `internet-of-things`, `iot`
...
## Security Resources (2 Repositories)

### [awesome-honeypots](https://github.com/paralax/awesome-honeypots)
an awesome list of honeypot resources

**Details:** ⭐ 10100 `Python` `honeypot`, `awesome-list`, `awesome`
...
**Details:** ⭐ 5572  `infosec`, `pentest`, `courses`
...
**Details:** ⭐ 418 `PowerShell` 

---

## Developer Resources (2 Repositories)

### [awesome-readme](https://github.com/matiassingers/awesome-readme)
A curated list of awesome READMEs

**Details:** ⭐ 20339  `awesome-list`, `awesome`, `list`
...
**Details:** ⭐ 2092  `ai`, `awesome`, `awesome-list`

---

## Remote Desktop & Access (1 Repositories)
...
**Details:** ⭐ 10516 `C#` `mremoteng`, `rdp`, `ssh`

---

## Monitoring & Logging (1 Repositories)

### [klogg](https://github.com/variar/klogg)
Really fast log explorer based on glogg project

**Details:** ⭐ 3185 `C++` `logs`, `windows`, `linux`
...
**Details:** ⭐ 2348 `TypeScript` `customer-feedback`, `self-hosted`, `ruby-on-rails`
...
**Details:** ⭐ 22263 `TypeScript` `data-format`, `llm`, `serialization`

---

## Security Analytics (1 Repositories)
...
| Kategorie | Anzahl |
|-----------|--------|
| PowerShell Modules & Tools | 12 |
| AI Development Tools | 10 |
| Security & Compliance | 9 |
| Windows Administration | 7 |
| AI Integration & MCP Servers | 6 |
| Microsoft 365 & Azure | 6 |
| AI & Machine Learning | 5 |
| Security Monitoring & Response | 5 |
| macOS Tools | 5 |
| DevOps & CI/CD | 4 |
