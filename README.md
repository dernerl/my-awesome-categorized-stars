...
📊 **103 Repositories** in **18 Kategorien**  
🕐 **Letztes Update:** 2026-01-27 04:11:08  
🤖 **Generiert mit:** Atlassian CLI (ACLI) Rovo Dev

## 📂 Kategorien-Übersicht

- [AI & LLM Development](#ai--llm-development-21-repositories) (21 Repositories)
- [Security & Compliance](#security--compliance-16-repositories) (16 Repositories)
- [Infrastructure & System Administration](#infrastructure--system-administration-15-repositories) (15 Repositories)
- [PowerShell Tools & Modules](#powershell-tools--modules-11-repositories) (11 Repositories)
...
- [Cloud & Azure](#cloud--azure-4-repositories) (4 Repositories)
- [Windows Desktop & UI](#windows-desktop--ui-4-repositories) (4 Repositories)
- [Development Tools & Utilities](#development-tools--utilities-4-repositories) (4 Repositories)
- [macOS Tools](#macos-tools-3-repositories) (3 Repositories)
- [Collaboration & Communication](#collaboration--communication-3-repositories) (3 Repositories)
- [AI Image Generation](#ai-image-generation-2-repositories) (2 Repositories)
...
**Details:** ⭐ 65390 `Python` `ai`, `copilot`, `development`
...
**Details:** ⭐ 22192 `TypeScript` `data-format`, `llm`, `serialization`
...
**Details:** ⭐ 20217 `TypeScript` `anthropic`, `anthropic-claude`, `claude`
...
**Details:** ⭐ 19835 `TypeScript` `spec`, `ai`, `context-engineering`
...
**Details:** ⭐ 12735 `TypeScript` `ai`, `cursor`, `figma`
...
**Details:** ⭐ 2091  `ai`, `awesome`, `awesome-list`
...
**Details:** ⭐ 378 `TypeScript` `mcp`, `mcp-server`, `mermaid`
...
**Details:** ⭐ 10099 `Python` `honeypot`, `awesome-list`, `awesome`
...
**Details:** ⭐ 5571  `infosec`, `pentest`, `courses`
...
**Details:** ⭐ 4020 `C#` `defender`, `firewall-configuration`, `harden`
...
**Details:** ⭐ 2503 `Python` `azure-active-directory`, `azuread`, `microsoft-graph`
...
**Details:** ⭐ 2227 `YAML` `apple`, `macos`, `compliance`
...
**Details:** ⭐ 464 `Python` `crowdstrike`, `oauth2`, `falconpy`
...
**Details:** ⭐ 159 `PowerShell` `audit`, `compliance`, `cis`
...
## Infrastructure & System Administration (15 Repositories)
...
## PowerShell Tools & Modules (11 Repositories)

### [PowerShell](https://github.com/PowerShell/PowerShell)
PowerShell for every system!

**Details:** ⭐ 51264 `C#` `powershell`, `windows`, `macos`
...
**Details:** ⭐ 5331 `PowerShell` `powershell`, `windows-powershell`, `powershell-ise`
...
**Details:** ⭐ 67799 `Python` `python`, `ansible`
...
**Details:** ⭐ 20336  `awesome-list`, `awesome`, `list`
...
## Windows Desktop & UI (4 Repositories)

### [komorebi](https://github.com/LGUG2Z/komorebi)
A tiling window manager for Windows 🍉

**Details:** ⭐ 13891 `Rust` `tiling-window-manager`, `windows`, `rust`
...
**Details:** ⭐ 10510 `C#` `mremoteng`, `rdp`, `ssh`
...
**Details:** ⭐ 3184 `C++` `logs`, `windows`, `linux`

---

## Development Tools & Utilities (4 Repositories)

### [tremor-npm](https://github.com/tremorlabs/tremor-npm)
React components to build charts and dashboards

**Details:** ⭐ 16448 `TypeScript` `reactjs`, `tailwindcss`, `ui-system`
...
**Details:** ⭐ 25605 `Swift` `macos`, `menubar`, `statusbar`
...
## Collaboration & Communication (3 Repositories)
...
## AI Image Generation (2 Repositories)

### [flux](https://github.com/black-forest-labs/flux)
Official inference repo for FLUX.1 models

**Details:** ⭐ 25141 `Python` 
...
**Details:** ⭐ 1321 `Svelte` `private-notes`, `privnote`, `secure-notes`
...
**Details:** ⭐ 3822  `awesome-list`, `internet-of-things`, `iot`
...
**Details:** ⭐ 2347 `TypeScript` `customer-feedback`, `self-hosted`, `ruby-on-rails`
...
## Crypto & Blockchain (1 Repositories)
...
| Kategorie | Anzahl |
|-----------|--------|
| AI & LLM Development | 21 |
| Security & Compliance | 16 |
| Infrastructure & System Administration | 15 |
| PowerShell Tools & Modules | 11 |
| DevOps & Automation | 7 |
| Documentation & Resources | 5 |
| Cloud & Azure | 4 |
| Windows Desktop & UI | 4 |
| Development Tools & Utilities | 4 |
| macOS Tools | 3 |
