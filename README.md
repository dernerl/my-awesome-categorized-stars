...
📊 **153 Repositories** in **7 Kategorien**  
🕐 **Letztes Update:** 2026-04-02 05:07:58  
🤖 **Generiert mit:** Atlassian CLI (ACLI) Rovo Dev

## 📂 Kategorien-Übersicht

- [Web Development](#web-development-57-repositories) (57 Repositories)
- [Data Science & ML](#data-science--ml-34-repositories) (34 Repositories)
- [Other](#other-34-repositories) (34 Repositories)
- [Mobile Development](#mobile-development-10-repositories) (10 Repositories)
- [Programming Languages](#programming-languages-7-repositories) (7 Repositories)
...
## Web Development (57 Repositories)

### [openclaw](https://github.com/openclaw/openclaw)
Your own personal AI assistant. Any OS. Any Platform. The lobster way. 🦞 

**Details:** ⭐ 344934 `TypeScript` `ai`, `assistant`, `own-your-data`
...
**Details:** ⭐ 182073 `TypeScript` `automation`, `ipaas`, `n8n`
...
**Details:** ⭐ 41555 `TypeScript` `react`, `video`, `javascript`
...
**Details:** ⭐ 36428 `TypeScript` `spec`, `ai`, `context-engineering`
...
**Details:** ⭐ 23610 `TypeScript` `data-format`, `llm`, `serialization`
...
**Details:** ⭐ 21242 `TypeScript` `anthropic`, `anthropic-claude`, `claude`
...
**Details:** ⭐ 18271 `JavaScript` `claude`, `codex`, `marketing`
...
**Details:** ⭐ 17495 `TypeScript` `ai-coding`, `vscode`, `vscode-extension`
...
**Details:** ⭐ 16958 `TypeScript` `claude-code`, `claude-desktop`, `codex`
...
**Details:** ⭐ 15197 `TypeScript` `cli`, `command`, `vercel`
...
**Details:** ⭐ 14089 `TypeScript` `ai`, `cursor`, `figma`
...
**Details:** ⭐ 1126 `TypeScript` `drag-and-drop`, `homelab`, `rack`
...
**Details:** ⭐ 524 `TypeScript` `ai`, `artifacts`, `boilerplate`
...
**Details:** ⭐ 503 `TypeScript` `mcp`, `mcp-server`, `mermaid`
...
**Details:** ⭐ 439 `TypeScript` `cli`, `mcp`, `mcp-client`
...
**Details:** ⭐ 395 `JavaScript` `claude`, `claudecode`, `databricks`
...
**Details:** ⭐ 368 `TypeScript` `automation`, `build`, `filewatcher`
...
## Data Science & ML (34 Repositories)

### [skills](https://github.com/anthropics/skills)
Public repository for Agent Skills

**Details:** ⭐ 108606 `Python` `agent-skills`
...
**Details:** ⭐ 84521 `Python` `ai`, `copilot`, `development`
...
**Details:** ⭐ 68379 `Python` `python`, `ansible`
...
**Details:** ⭐ 50331 `Python` `claude`, `claude-code`, `agent-skills`
...
**Details:** ⭐ 23496 `Rust` `google-workspace`, `agent-skills`, `ai-agent`
...
**Details:** ⭐ 22980 `Python` `agents`, `artificial-intelligence`, `cybersecurity`
...
**Details:** ⭐ 4543 `Python` `python`, `ricing`, `status-bar`
...
**Details:** ⭐ 2569 `Python` `azure-active-directory`, `azuread`, `microsoft-graph`
...
**Details:** ⭐ 1327 `Python` `agent-skills`, `ai`, `automation`
...
**Details:** ⭐ 660 `Python` `agent-skills`, `opc`, `ai-tools`
...
**Details:** ⭐ 484 `Python` `crowdstrike`, `oauth2`, `falconpy`
...
**Details:** ⭐ 96 `Python` `agent`, `agents`, `ai`
...
**Details:** ⭐ 52219 `C#` `powershell`, `windows`, `macos`
...
**Details:** ⭐ 20675  `awesome-list`, `awesome`, `list`
...
**Details:** ⭐ 10701 `C#` `mremoteng`, `rdp`, `ssh`
...
**Details:** ⭐ 3887  `awesome-list`, `internet-of-things`, `iot`
...
**Details:** ⭐ 26937 `Swift` `macos`, `menubar`, `statusbar`
...
**Details:** ⭐ 17449 `Swift` `openemu`, `objective-c`, `macos`
...
**Details:** ⭐ 1878 `Swift` `claude`, `claude-ai`, `claude-code`
...
## Programming Languages (7 Repositories)

### [komorebi](https://github.com/LGUG2Z/komorebi)
A tiling window manager for Windows 🍉

**Details:** ⭐ 14341 `Rust` `tiling-window-manager`, `windows`, `rust`
...
**Details:** ⭐ 7395 `C++` `desktop`, `windows`, `xaml`
...
**Details:** ⭐ 3271 `C++` `logs`, `windows`, `linux`
...
**Details:** ⭐ 155 `Rust` `cmtrace`, `intune`
...
**Details:** ⭐ 6083 `Groovy` `rundeck`, `devops`, `deployment`
